  ...
  <div class="app-dataScreening-container">
    ...
    <div class="app-dataScreening-item app-dataScreening-listWrapper">
      ...
      <div class="app-dataScreening-head">
        ...
        <el-button type="success" class="btn-search app-dataScreening-export" @click="listExport"><i class="el-icon-upload el-icon--right"></i>全部导出</el-button>
      </div>
      <!--标签-->
        ...
        <div v-show="listSort == 0">
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <div style="width:70%;display: inline-block">
                  <el-progress :text-inside="true" :stroke-width="20" :percentage="scope.row.progress1" :show-text="false" :color="customColor1"></el-progress>
                </div>
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <div style="width:70%;display: inline-block">
                  <el-progress :text-inside="true" :stroke-width="20" :percentage="scope.row.progress2" :show-text="false" :color="customColor2"></el-progress>
                </div>
            ...
            <el-table-column
              ...
              width="250">
                <template slot-scope="scope">
                  <div style="width:70%;display: inline-block">
                    <el-progress :text-inside="true" :stroke-width="20" :percentage="scope.row.progress3" :show-text="false" :color="customColor3"></el-progress>
                  </div>
        ...
        <div v-show="listSort == 1">
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <div style="width:70%;display: inline-block">
                  <el-progress :text-inside="true" :stroke-width="20" :percentage="scope.row.progress1" :show-text="false"></el-progress>
                </div>
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <div style="width:70%;display: inline-block">
                  <el-progress :text-inside="true" :stroke-width="20" :percentage="scope.row.trainUserPercent" :show-text="false"></el-progress>
                </div>
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <div style="width:70%;display: inline-block">
                  <el-progress :text-inside="true" :stroke-width="20" :percentage="scope.row.progress2" :show-text="false"></el-progress>
                </div>
    ...
    <div class="app-dataScreening-item app-dataScreening-statisticWrapper">
      ...
      <div class="app-dataScreening-head app-dataScreening-statistic-head">
        ...
        <el-button type="success" class="btn-search app-dataScreening-export" @click="statisticExport"><i class="el-icon-upload el-icon--right"></i>全部导出</el-button>
      </div>
      <!--内容-->
      <div class="app-dataScreening-statistic-body">
        ...
        <div class="app-dataScreening-employeePortraitWrapper clearfix">
          <div class="app-dataScreening-head app-dataScreening-employeePortraitHead">
            ...
            <el-button type="success" class="btn-search app-dataScreening-export" @click="dialog=true"><i class="el-icon-upload el-icon--right"></i>生成对比图</el-button>
          </div>
          <div class="fl w55 employeePortrait-eacharts">
            <!--员工画像概览-->
            <div id="employeePortraitData" style="width:100%;height:100%;position: relative"></div>
          </div>
          <div class="fr w45 employeePortrait-eacharts">
            <div id="compareData" style="width:100%;height:100%;position: relative"></div>
          </div>
          <!--对比弹框-->
          <div class="app-dataScreening-compare" v-show="dialog">
        ...
        <div class="app-dataScreening-employeeActivityWrapper">
          ...
          <div class="employeePortrait-eacharts" style="width:100%;">
            <div id="employeeActivityData" style="width:100%;height:100%;position: relative"></div>
          </div>
        </div>
        ...
        <div class="app-dataScreening-employeeActivityGroups clearfix">
          ...
          <div class="app-dataScreening-employeeActivityGroups-item">
            ...
            <div class="app-dataScreening-employeeActivityGroups-body" id="employeeActivityExamQualified">
        </div>
          </div>
          <!--学习热度榜-->
          <div class="app-dataScreening-employeeActivityGroups-item">
            ...
            <div class="app-dataScreening-employeeActivityGroups-body" id="employeeActivityTrainViewTime">
            </div>
          </div>
          <!--发布课程榜-->
          <div class="app-dataScreening-employeeActivityGroups-item">
            ...
            <div class="app-dataScreening-employeeActivityGroups-body" id="employeeActivityPublishTrainCount">
          ...
          <div class="app-dataScreening-employeeActivityGroups-item">
            ...
            <div class="app-dataScreening-employeeActivityGroups-body" id="employeeActivityExamUserPercent">
            </div>
          </div>
        </div>
