  ...
  <div class="app-container">
    <div id="topSearch">
      ...
      <el-popover
        ...
        trigger="click"
      >
        <el-input placeholder="请输入内容" /><el-input placeholder="请输入内容" /><el-input placeholder="请输入内容" /><el-input placeholder="请输入内容" />
        <el-input placeholder="请输入内容" />
        <el-input placeholder="请输入内容" />

        <div id="searchPopoverBtn">
          <el-button type="primary" @click="topSearch">确定</el-button>
