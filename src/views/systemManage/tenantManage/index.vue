    ...
    <div>
      ...
      >
        ...
        <el-table-column class-name="status-col" label="操作" width="280" align="center" show-overflow-tooltip>
          <template slot-scope="scope">
            <el-button size="mini" @click="edit(scope.row.id)"><i class="iconfont iconxiugai" /><i></i>修改</el-button>
            ...
            <el-dropdown>
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item><i class="iconfont iconzixun"></i>资讯</el-dropdown-item>
                <el-dropdown-item><i class="iconfont iconshanchu"></i>删除</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </template>
        </el-table-column>
      ...
      <div class="page-piliang">
        <el-button type="primary"><i class="iconfont iconshanchu"></i>批量删除</el-button>
