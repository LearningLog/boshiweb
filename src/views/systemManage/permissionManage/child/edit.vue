<template>
  <div class="form-edit">
    <el-form ref="form" class="form" :model="form" :rules="rules" :status-icon="true" label-width="120px">
      ...
      <el-form-item label="所属菜单" prop="permissionbelongmenu2">
      ...
      <el-form-item label="权限类别" prop="permissionmanage">
...
<script>
import { permission_edit, permission_det, permission_menu, permission_manage_type } from '@/api/system-manage/permissionManage.js'
